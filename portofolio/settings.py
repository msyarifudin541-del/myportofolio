...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "muhammad-syarifudin51-myportofolio.pws.cs.ui.ac.id"]
...
SECRET_KEY = 'django-insecure--qarq+ayf!=qz0ae+ugm%dpow!^d%6uyxkqc$ng$#lm3e&)go&'
